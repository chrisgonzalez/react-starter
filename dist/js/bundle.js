...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stackedBar = __webpack_require__(168);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_stackedBar2.default, this.props)
	            );
	        }
	    }]);
	...
	var createViz = function createViz(data) {
	    ...
	    var visualization = _react2.default.createElement(App, { data: data, elem: elem });
	...
	var StackedBar = function (_Component) {
	    ...
	    _createClass(StackedBar, [{
	        ...
	        value: function renderStackedBar() {
	            ...
	            var x = _d2.default.scale.ordinal().rangeRoundBands([0, elemWidth], .1);

	            var maxValue = _d2.default.max(this.props.data.map(function (d) {
	                return d['drugs'] + d['no drugs'];
	            }));
	            var y = _d2.default.scale.linear().domain([0, maxValue]).range([elemHeight, 0]);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('svg', { className: 'stacked-bar' });
	        }
	    }]);
