...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stackedBar = __webpack_require__(160);
	...
	var _yAxis = __webpack_require__(171);
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(_stackedBar2.default, _extends({}, this.props, {
	                    keyMapping: ['drugs', 'no drugs']
	                })),
	                _react2.default.createElement(_xAxis2.default, _extends({}, this.props, {
	                    labelKey: 'year'
	                })),
	                _react2.default.createElement(_yAxis2.default, _extends({}, this.props, {
	                    keyMapping: ['drugs', 'no drugs'],
	                    labelKey: 'year'
	                }))
	            );
	...
	var createViz = function createViz(data) {
	    var elem = document.querySelector('#visualization');
	    var visualization = _react2.default.createElement(App, { data: data, elem: elem, gutter: [50, 20, 50, 60] });
	    (0, _reactDom.render)(visualization, elem);
	};

	_d2.default.csv("lethal-injection-executions.csv", function (error, data) {
	    createViz(data);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StackedBar = function (_Component) {
	    ...
	    function StackedBar(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StackedBar).call(this, props));

	        _this.renderStackedBar = _this.renderStackedBar.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(StackedBar, [{
	        ...
	        value: function renderStackedBar() {
	            ...
	            var keyMapping = _props.keyMapping;
	            var gutter = _props.gutter;
	            var data = _props.data;
	            var elem = _props.elem;


	            var elemHeight = parseInt(window.getComputedStyle(elem).height);
	            var elemWidth = parseInt(window.getComputedStyle(elem).width);

	            var maxValue = _d2.default.max(data.map(function (d) {
	                return keyMapping.reduce(function (prev, key) {
	                    return prev + +d[key];
	                }, 0);
	            }));

	            var x = _d2.default.scale.ordinal().domain(data.map(function (d, i) {
	                return i;
	            })).rangeRoundBands([gutter[3], elemWidth - gutter[1]], .2);

	            var y = _d2.default.scale.linear().domain([0, maxValue]).rangeRound([elemHeight - gutter[2], gutter[0]]);
	            ...
	            bars.enter().append('g').attr('class', 'bar-group').each(function (d) {
	                ...
	                keyMapping.forEach(function (key) {
	                    barGroup.append('rect').attr('data-key', key);
	                });
	            });

	            bars.attr('transform', function (d, i) {
	                var xPos = x(i);
	                var yPos = y(keyMapping.reduce(function (value, key) {
	                    return value + +d[key];
	                }, 0));
	                ...
	                keyMapping.forEach(function (key, i) {
	                    var yVal = 0;
	                    ...
	                    barGroup.select('[data-key="' + key + '"]').attr('width', function () {
	                        return x.rangeBand();
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('g', { className: 'stacked-bar' });
	        }
	    }]);
	...
	StackedBar.propTypes = {
	    ...
	    keyMapping: _react.PropTypes.array,
	    gutter: _react.PropTypes.array
	};
	...
	var XAxis = function (_Component) {
	    ...
	    _createClass(XAxis, [{
	        ...
	        value: function renderAxis() {
	            ...
	            var x = _d2.default.scale.ordinal().domain(data.map(function (d, i) {
	                return labelKey && d[labelKey] || i;
	            })).rangeRoundBands([gutter[3], elemWidth - gutter[1]], .2);

	            var xAxis = _d2.default.svg.axis().scale(x).orient("bottom").outerTickSize(1);
	            ...
	            var axis = _d2.default.select(elem).select('.x-axis').attr('transform', function () {
	                return 'translate(0, ' + (elemHeight - gutter[2]) + ')';
	            }).call(xAxis);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement('g', { className: 'x-axis' });
	        }
	    }]);
	...
	var YAxis = function (_Component) {
	    ...
	    _createClass(YAxis, [{
	        ...
	        value: function renderAxis() {
	            ...
	            var yAxis = _d2.default.svg.axis().scale(y).orient("left").outerTickSize(1);

	            var axis = _d2.default.select(elem).select('.y-axis').attr('transform', function () {
	                return 'translate(' + gutter[3] + ', 0)';
	            }).call(yAxis);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement('g', { className: 'y-axis' });
	        }
	    }]);
